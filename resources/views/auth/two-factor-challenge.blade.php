    ...
    <div x-data="{ recovery: false }">
      ...
      <form method="POST" action="{{ route('two-factor.login') }}">
        ...
        <div class="mt-4 flex items-center justify-end">
          <button type="button" class="cursor-pointer text-sm text-gray-600 underline hover:text-gray-900 dark:text-gray-400" x-show="! recovery" x-on:click="
            recovery = true
            $nextTick(() => {
          ...
          <button type="button" class="cursor-pointer text-sm text-gray-600 underline hover:text-gray-900 dark:text-gray-400" x-cloak x-show="recovery" x-on:click="
            recovery = false
            $nextTick(() => {
              $refs.code.focus()
            })

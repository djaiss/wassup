      ...
      <div class="mt-5 space-y-6">
        ...
        @foreach ($this->sessions as $session)
          <div class="flex items-center">
            ...
            <div class="ms-3">
              <div class="text-sm text-gray-600 dark:text-gray-400">{{ $session->agent->platform() ? $session->agent->platform() : __('Unknown') }} - {{ $session->agent->browser() ? $session->agent->browser() : __('Unknown') }}</div>

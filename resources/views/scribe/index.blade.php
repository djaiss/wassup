...
<aside>
    <strong>Base URL</strong>: <code>https://wassup.test</code>
</aside>
...
<p>Organizations are created by users. Any user, regardless of their role, can
create an organization.</p>
<p>Organizations are identified by a unique code. This code is used to let
other users join the organization.</p>
<p>Organizations also have a slug. This slug is used to identify the organization
in the URL.</p>
...
<p>This API call returns a paginated collection of organizations that contains
15 items per page.</p>
...
<span id="execution-results-GETapi-organizations--organization-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-organizations--organization-"></span>:
    </blockquote>
...
<form id="form-GETapi-organizations--organization-" data-method="GET"
      data-path="api/organizations/{organization}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-organizations--organization-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="GETapi-organizations--organization-"
               value="1"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the organization. Max 255 characters. Example: <code>Acme, Inc.</code></p>
        </div>
        </form>
...
<p>Only administrators can update an organization.
...
<span id="execution-results-PUTapi-organizations--organization-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-organizations--organization-"></span>:
    </blockquote>
...
<form id="form-PUTapi-organizations--organization-" data-method="PUT"
      data-path="api/organizations/{organization}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-organizations--organization-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="PUTapi-organizations--organization-"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-organizations--organization-"
               value="Acme, Inc."
               data-component="body">
    <br>
<p>The name of the organization. Max 255 characters. Example: <code>Acme, Inc.</code></p>
...
<span id="execution-results-DELETEapi-organizations--organization-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-organizations--organization-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-organizations--organization-" data-method="DELETE"
      data-path="api/organizations/{organization}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-organizations--organization-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-organizations--organization-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="DELETEapi-organizations--organization-"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<p>This API call returns a paginated collection of cycles that contains
15 items per page.</p>
...
<span id="execution-results-GETapi-organizations--organization--cycles" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-organizations--organization--cycles"></span>:
    </blockquote>
...
<form id="form-GETapi-organizations--organization--cycles" data-method="GET"
      data-path="api/organizations/{organization}/cycles"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-organizations--organization--cycles', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-organizations--organization--cycles"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-organizations--organization--cycles"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="GETapi-organizations--organization--cycles"
               value="recusandae"
               data-component="url">
    <br>
<p>The organization. Example: <code>recusandae</code></p>
            </div>
                    </form>
...
<p>Retrieves the current active cycle for the organization, if there is one.
If there is no active cycle, it will return an empty response.</p>
...
<span id="execution-results-GETapi-organizations--organization--cycles-active" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-organizations--organization--cycles-active"></span>:
    </blockquote>
...
<form id="form-GETapi-organizations--organization--cycles-active" data-method="GET"
      data-path="api/organizations/{organization}/cycles/active"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-organizations--organization--cycles-active', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-organizations--organization--cycles-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-organizations--organization--cycles-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="GETapi-organizations--organization--cycles-active"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<p>Cycles can have a public URL. This URL is used to tell the world about the
cycle.</p>
...
<span id="execution-results-POSTapi-organizations--organization--cycles" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-organizations--organization--cycles"></span>:
    </blockquote>
...
<form id="form-POSTapi-organizations--organization--cycles" data-method="POST"
      data-path="api/organizations/{organization}/cycles"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-organizations--organization--cycles', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="quaerat"
               data-component="url">
    <br>
<p>The organization. Example: <code>quaerat</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>number</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="number"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="1"
               data-component="body">
    <br>
<p>The number of the cycle. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="This is a description of the cycle."
               data-component="body">
    <br>
<p>The description of the cycle. Example: <code>This is a description of the cycle.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>started_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="started_at"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="2024-01-01"
               data-component="body">
    <br>
<p>The start date of the cycle, in ISO 8601 format (YYYY-MM-DD). Example: <code>2024-01-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>ended_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ended_at"                data-endpoint="POSTapi-organizations--organization--cycles"
               value="2024-01-01"
               data-component="body">
    <br>
<p>The end date of the cycle, in ISO 8601 format (YYYY-MM-DD). Example: <code>2024-01-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>is_active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
            ...
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="POSTapi-organizations--organization--cycles"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-organizations--organization--cycles" style="display: none">
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Whether the cycle is public. Example: <code>true</code></p>
        </div>
        </form>
...
<span id="execution-results-GETapi-organizations--organization--cycles--cycle-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-organizations--organization--cycles--cycle-"></span>:
    </blockquote>
...
<form id="form-GETapi-organizations--organization--cycles--cycle-" data-method="GET"
      data-path="api/organizations/{organization}/cycles/{cycle}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-organizations--organization--cycles--cycle-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="GETapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="cycle"                data-endpoint="GETapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The number of the cycle. Please note that this is not the id of the cycle. Example: <code>1</code></p>
            </div>
                    </form>
...
<span id="execution-results-PUTapi-organizations--organization--cycles--cycle-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-organizations--organization--cycles--cycle-"></span>:
    </blockquote>
...
<form id="form-PUTapi-organizations--organization--cycles--cycle-" data-method="PUT"
      data-path="api/organizations/{organization}/cycles/{cycle}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-organizations--organization--cycles--cycle-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="cycle"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The number of the cycle. Please note that this is not the id of the cycle. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="number"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="body">
    <br>
<p>The number of the cycle. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="This is a description of the cycle."
               data-component="body">
    <br>
<p>The description of the cycle. Max 4294967295 characters. Example: <code>This is a description of the cycle.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>started_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="started_at"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="2024-01-01"
               data-component="body">
    <br>
<p>The start date of the cycle, in ISO 8601 format (YYYY-MM-DD). Example: <code>2024-01-01</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ended_at"                data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
               value="2024-01-01"
               data-component="body">
    <br>
<p>The end date of the cycle, in ISO 8601 format (YYYY-MM-DD). Example: <code>2024-01-01</code></p>
...
<i>optional</i> &nbsp;
            ...
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-organizations--organization--cycles--cycle-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-organizations--organization--cycles--cycle-" style="display: none">
...
<span id="execution-results-DELETEapi-organizations--organization--cycles--cycle-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-organizations--organization--cycles--cycle-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-organizations--organization--cycles--cycle-" data-method="DELETE"
      data-path="api/organizations/{organization}/cycles/{cycle}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-organizations--organization--cycles--cycle-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-organizations--organization--cycles--cycle-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="organization"                data-endpoint="DELETEapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The id of the organization. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="cycle"                data-endpoint="DELETEapi-organizations--organization--cycles--cycle-"
               value="1"
               data-component="url">
    <br>
<p>The number of the cycle. Please note that this is not the id of the cycle. Example: <code>1</code></p>

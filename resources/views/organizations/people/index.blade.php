          ...
          <div class="rounded-md border border-gray-200 bg-white p-5 sm:rounded-lg dark:bg-gray-800">
            ...
            <div class="flex justify-center">
              <div x-data="{
                  ...
                  <button @click="copyToClipboard();" class="flex items-center justify-center w-auto h-8 px-3 py-1 text-md font-mono bg-white border rounded-md cursor-pointer border-neutral-200/60 hover:bg-neutral-100 active:bg-white focus:bg-white focus:outline-none text-neutral-500 hover:text-neutral-600 group">
                      ...
                      <span x-show="copyNotification" class="tracking-tight text-green-500 font-sans text-sm" x-cloak>Copied</span>
